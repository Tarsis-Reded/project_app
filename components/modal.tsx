...
const ModalC = ({item}) => {
  ...
  return(
       <View style={{justifyContent: 'flex-start', backgroundColor: '#EDEFF2', borderRadius: 15, height: 1000}}>
        <View style={{backgroundColor: '#EDEFF2', borderColor: 'black', borderRadius: 20, alignSelf: 'center', shadowColor: 'black', }}>
          ...
          <View>
            ...
            <TextInput
              ...
              // placeholder="TESTE"
              defaultValue={curruntItem.title}
            // value={text}
          ...
          <View style={{ paddingTop: 10 }}>
            ...
            <SelectList
              ...
              // defaultOption={roomsHouse.find(({ value }) => value === curruntItem.partHome)}    //deixar dinaminamico de acordo com o dispositivo
